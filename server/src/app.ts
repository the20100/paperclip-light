...
import { lightExecutionRoutes } from "./routes/light-execution.js";
...
import { civilizationChatRoutes } from "./routes/civilization-chat.js";
...
export async function createApp(
  ...
  api.use(workbenchRoutes(db));
  api.use(lightExecutionRoutes(db));
  ...
  api.use(civilizationChatRoutes(db, { deploymentMode: opts.deploymentMode }));
